...
public class MainActivity extends AppCompatActivity implements INaviInfoCallback , AMap.OnPOIClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Common.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(MainActivity.this, CommonActivity.class);//this前面为当前activty名称，class前面为要跳转到得activity名称
                ...
                if(grantResults.length>0){
                    for(int result:grantResults){
                        if(result!=PackageManager.PERMISSION_GRANTED){
                            Toast.makeText(MainActivity.this, "您拒绝了权限申请！",
